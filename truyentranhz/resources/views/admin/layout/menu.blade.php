<div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="admin/truyen/danhsach"><i class="fa fa-bar-chart-o fa-fw"></i>Truyện<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="admin/truyen/danhsach">Danh Sách</a>
                                </li>
                                <li>
                                    <a href="admin/truyen/them">Thêm</a>
                                </li>
                                <li>
                                    <a href="admin/truyen/truyendadang">Truyện Đã Đăng</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
