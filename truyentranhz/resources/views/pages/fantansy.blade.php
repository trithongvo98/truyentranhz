	        ...
	        <div class="row">
	            ...
	            <div class="col-md-9 ">
	                <div class="panel panel-default">
	                    ...
	                    @if($tt->id > 1017 && $tt->id<1021||$tt->id ==1023||$tt->id == 1025||$tt->id==1026 ||$tt->id==1032||$tt->id==1034)
	                    <div class="row-item row div-items hidden" id="div-{{ $items }}">
	                        ...
	                        <div class="col-md-9">
	                            ...
	                            <a class="btn btn-primary" href="detail.html">Đọc truyện <span class="glyphicon glyphicon-chevron-right"></span></a>
	                        </div>
	                        <div class="break"></div>
	                    </div>
	                    @endif
